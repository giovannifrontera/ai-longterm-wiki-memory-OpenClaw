...
All layers are indexed in the same Qdrant vector space. The agent accesses everything through semantic search — directory structure is organisational, not a barrier.
